 ...
 * Use the [DetalleCitaPacienteFragment.newInstance] factory method to
...
class DetalleCitaPacienteFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetalleCitaPacienteFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetalleCitaPacienteFragment().apply {
