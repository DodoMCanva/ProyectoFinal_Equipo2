 ...
 * Use the [DetalleCitaMedicoFragment.newInstance] factory method to
...
class DetalleCitaMedicoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetalleCitaMedicoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetalleCitaMedicoFragment().apply {
