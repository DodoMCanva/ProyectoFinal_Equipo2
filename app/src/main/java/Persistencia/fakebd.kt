...
object fakebd {
    ...
    init {
        ...
        medicos.add(medico("Fernando Lujano López", "fer@gmail.com", "6645565", "1990-01-15", "Femenino", "12/5/40", "fer12", 300.00, "C887DJJ3", "Cardiología", "Sonora", "Obregon", "Viena", "2037", "35180"));
        medicos.add(medico("Laura Zavala Quintero", "laura.med@gmail.com", "6654433", "1985-07-22", "Femenino", "14/7/38", "lau85", 500.00,"K123LMN7", "Pediatría", "Jalisco", "Guadalajara", "Colon", "1021", "44160"));
        medicos.add(medico("Marco Antonio Rodríguez Ruíz", "marco.ortiz@hotmail.com", "6677788", "1978-03-10", "Masculino", "10/3/40", "marco78", 800.00,"M987POQ9", "Dermatología", "CDMX", "CDMX", "Insurgentes", "305", "03100"));
        medicos.add(medico("Paola Martínez Murillo", "paola.garcia@gmail.com", "6688991", "1992-12-01", "Femenino", "01/12/44", "pao92", 600.00,"L554XYZ2", "Ginecología", "Nuevo Leon", "Monterrey", "Garza Sada", "100", "64700"));
        medicos.add(medico("Ricardo Jiménez Ochoa", "ricardo.medico@gmail.com", "6690002", "1980-05-30", "Masculino", "30/5/39", "rick80", 900.00,"H321QWE8", "Neurología", "Baja California", "Tijuana", "Reforma", "250", "22000"));
